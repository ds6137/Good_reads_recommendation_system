...
def main(spark, model_file, val_file, test_file):
	...
	'''rm_val=RegressionMetrics(predAndLabels_val)
	rmse_val=rm_val.rootMeanSquaredError
	print('Validation set, RMSE: {}'.format(rmse_val))

	rm_test=RegressionMetrics(predAndLabels_test)
	rmse_test=rm_test.rootMeanSquaredError
